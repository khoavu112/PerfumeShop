...
<body>
	...
	<div class="pageWrap">
		...
		<%
			...
			<div class="container">
				<ul class="tp-links">
					<li><a href="<%=request.getContextPath()%>/order"><span class="dropBox-btn">Xin chào &nbsp; <%=userInfor.getFullname() %></span></a>
					...
					<li><span class="site-search-btn dropBox-btn"><i
						...
						<div class="dropBox">
							<div class="box-section">
								...
								<form class="accounts-form clearfix" method="get" action="<%=request.getContextPath()%>/home/search">
									<%}else{
									String id = request.getParameter("id");
										%>
									<form class="accounts-form clearfix" method="get" action="<%=request.getContextPath()%>/home/searchCat">
										<input type="hidden" 
									...
									<div class="form-left">
										<div class="form-group">
											<input type="search" class="form-control"
												placeholder="Search Key" name="nameSearch" value="">
										</div>
									</div>
									<input type="submit" class="btn btn-default text-uppercase"
										value="Tìm kiếm">
			...
			<div class="main-nav-bar">
				<nav class="navbar-collapse collapse">
					<ul class="main-nav">
						...
						<li>
							<a href="<%=request.getContextPath()%>/home">Loại sản phẩm</a>
							<ul>
								<%
