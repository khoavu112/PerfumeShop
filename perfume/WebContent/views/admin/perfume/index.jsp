    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
	      ...
	      <div class="col-sm-6">
            <form method="GET" action="<%=request.getContextPath()%>/admin/perfume/search" class="form-inline">				
                
                 <%
            	if(request.getAttribute("listCatPer") != null){
            		
            		List<CatPerfume> listCatPer = (List<CatPerfume>)request.getAttribute("listCatPer");
            		if(listCatPer.size() > 0){
            			%>
            			<select id="catPer" class="btn-sm form-control" name="catPer">
	      				  <option value="0">--- Loại sản phẩm ---</option>
	      				  <%
	      				  	for(CatPerfume catPer : listCatPer){
	      				  		int id = catPer.getId();
	      				  		String nameCatPer = catPer.getCatPerfume();
	      				  		%>
	      				  			<option value="<%=id%>"><%=nameCatPer %></option>
	      				  		<%
	      				  	}
	      				  %>
	      				</select>
