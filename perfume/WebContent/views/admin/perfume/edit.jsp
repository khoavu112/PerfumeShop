									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<input type="text" id="idPF" value="<%=product.getId()%>"
													name="idPF" class="form-control" />
											</div>
											<div class="form-group">
												<label for="name">Tên nước hoa</label> <input type="text"
													id="name" value="<%=product.getPerfumes()%>" name="name"
													class="form-control" />
											</div>
											<div class="row">
												<div class="col-sm-4">
													...
													%>
													<div class="form-group">
														<label for="cat">Loại nước hoa</label> <select
															name="catPF" id="cars" class="form-control">
															...
															<option value="<%=idCatPF%>"
																<%if (catPF == idCatPF)
								out.print("selected");%>><%=nameCatPF%></option>
															<%
																}
															%>
														</select>
												...
												<div class="col-sm-4">
													<div class="form-group">
														<label for="code">Mã sản phẩm</label> <input type="text"
															id="code" value="<%=product.getCodePerfume()%>"
															name="codePF" class="form-control" />
													</div>
												</div>
												<div class="col-sm-4">
													<div class="form-group">
														<label for="brand">Thương hiệu</label> <input type="text"
															id="brand" value="<%=product.getBrand()%>" name="brand"
															class="form-control" />
													</div>
												</div>
											</div>
											<div class="form-group">
												<label for="desciption">Mô tả</label> <input type="text"
													id="desciption" value="<%=product.getDescription()%>"
													name="desciption" class="form-control" />
											</div>
											<div class="form-group">
												<label for="detail">Chi tiết</label><br></br>
												<textarea rows="9" cols="70" id="detail" class="form-group"
										...
										<div class="col-sm-6">
											<div class="row">
												<div class="col-sm-3">
													<div class="form-group">
														<label for="made">Xuất xứ</label> <input type="text"
															id="made" value="<%=product.getMade()%>" name="made"
															class="form-control" />
													</div>
												</div>
												<div class="col-sm-3">
													<div class="form-group">
														<label for="capacity">Dung tích</label> <input type="text"
															id="capacity" value="<%=product.getCapacity()%>"
															name="capacity" class="form-control" />
													</div>
												</div>
												<div class="col-sm-3">
													<div class="form-group">
														<label for="quantum">Số lượng</label> <input type="text"
															id="quantum" value="<%=product.getAmount()%>"
															name="quantum" class="form-control" />
													</div>
												</div>
												<div class="col-sm-3">
													<div class="form-group">
														<label for="money">Giá tiền</label> <input type="text"
															id="money" value="<%=product.getMoney()%>" name="money"
															class="form-control" />
													</div>
												</div>
											</div>
												...
												<table class="table table-bordered">
													...
													<tbody>
														...
														<tr>
															...
															<td><img alt="picture" src="<%=pic%>"
																style="width: 200px; height: 200px" id="output"/></td>
															<td>
																<div class="form-group">
																	<label for="picture">Hình ảnh</label>&emsp;
																	...
																	<input type="file" multiple id="gallery-photo-add"
																		name="picture" accept="image/*" onchange="loadFile(event)">
