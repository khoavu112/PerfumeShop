      ...
      <div class="container-fluid">
        ...
        <table class="table table-striped table-bordered">
		  ...
		  <%
		    ...
		    int i = Integer.parseInt(request.getAttribute("STT")+"");
		  	...
		  	for(User objUser : userList){
		  		...
		  		int money = Integer.parseInt(objUser.getMoney());
